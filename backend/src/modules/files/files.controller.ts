...
export class FilesController {
   ...
   */
  // @Get(":id/preview")
  // async preview(@CurrentUser() user: AuthUser, @Param("id") id: string, @Res({ passthrough: false }) res: Response) {
  //   const { stream, mimeType, name } = await this.filesService.getPreviewStream(user.userId, user.email, id);
